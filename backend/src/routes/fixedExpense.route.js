...
import { createFixedExpenseSchema, editFixedExpenseSchema } from "../validators/fixedExpense.validator.js";
import { validate } from "../middleware/validation.middleware.js";

const router = express.Router();

router.post("/create-fixed-expense", protectRoute, validate(createFixedExpenseSchema), createFixedExpense);
router.get("/get-fixed-expenses", protectRoute, getFixedExpenses);
router.put("/edit-fixed-expense", protectRoute, validate(editFixedExpenseSchema), editFixedExpense);
router.delete("/delete-fixed-expense", protectRoute, deleteFixedExpense);
